            ...
            <table class="table table-bordered data-table">
              ...
              @foreach($subjects as $subject)
                <tr class="gradeX">
                  ...
                  <td style="text-align:center;"><h5>@foreach($subject->teachers as $teacher) {{$teacher->user_id}} @endforeach</h5></td>
                  <td style="text-align:center;"class="center"><a href="{{route('get.editAdminSubject',[$subject->id])}}" class="btn btn-primary">Edit</a> <a onclick="return confirm('Are you sure ?')" href="{{route('delete.adminSubject',[$subject->id])}}" class="btn btn-danger">Delete</a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
